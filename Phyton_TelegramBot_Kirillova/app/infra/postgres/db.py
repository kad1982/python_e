...
from pydantic import Secret,SecretStr, PostgresDsn
from sqlalchemy.ext.asyncio import create_async_engine, async_sessionmaker, AsyncSession
from sqlalchemy.orm import DeclarativeBase


class Database:
    def __init__(self, dsn: SecretStr, declarative_base: type[DeclarativeBase]):
        self.engine = create_async_engine(dsn.get_secret_value())
